...
define('CONTACTFORM_FROM_ADDRESS', 'mailer@skillsbuddy.nl');
define('CONTACTFORM_FROM_NAME', 'Contact Form on skillsbuddy.nl');
...
define('CONTACTFORM_TO_ADDRESS', 'skillsbuddynl@gmail.com');
define('CONTACTFORM_TO_NAME', 'Marc Roelofs');
